...
import 'create_post_modal_model.dart';
export 'create_post_modal_model.dart';
...
class _CreatePostModalWidgetState extends State<CreatePostModalWidget> {
  late CreatePostModalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreatePostModalModel());
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return FlutterFlowDropDown<int>(
                                      ...
                                      onChanged: (val) => safeSetState(() =>
                                          _model.selectCategoriaValue = val),
                                      width: 200.0,
                                      height: 40.0,
